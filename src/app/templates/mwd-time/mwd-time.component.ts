...
import { GenerateCanvasTimeTracksComponent } from 'src/app/components/generate-canvas-time-tracks/generate-canvas-time-tracks.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GenerateCanvasTimeTracksComponent],
  template: `
    <div class="mwd-time-container">
      
      
      <!-- Time-Based Canvas Tracks Component -->
      <app-generate-canvas-time-tracks 
